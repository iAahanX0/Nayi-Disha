...
const Home = () => {
  ...
  return (
    <div className='bg-[#fbfcfc]'>
      ...
      <div className="fade-in flex justify-between items-center my-20" style={{ padding: '50px 0' }}>
        {/* HeroSection */}
        <div className="w-1/2">
          <HeroSection />
        </div>
...
{/* Guidance Section for Freshers */}


      {/* CategoryCarousel appears with scroll-triggered animation */}
      <div ref={categoryRef} className="  opacity-0 pt-10 pb-10 mt-30">
        <CategoryCarousel />
      </div>
