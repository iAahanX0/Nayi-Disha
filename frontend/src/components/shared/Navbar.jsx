    ...
    return (
        <div className='bg-white border-b border-gray-900 '>
            <div className='flex items-center justify-between mx-auto max-w-7xl h-16'>
                <div>
                    <h1 className='text-2xl  font-bold text-[#FF0000]'><Link to="/">Nayi<span className='text-[#000000]'>Disha</span></Link></h1>
                </div>
                    ...
                    <ul className='flex font-medium items-center gap-5'>
                        {
                            user && user.role === 'recruiter' ? (
                                ...
                                <>
                                    ...
                                    <li className='text-[#000000]'><Link to="/skills">Skills</Link></li>
